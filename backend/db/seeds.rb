...
wake = Scenario.create(title: "Time to Wake Up!", content: "Ok, first thing’s first. Let’s get up", picture: "images/waking.jpg")
pets = Scenario.create(title: "Pets Time", content: "Evans’ tried-and-true advice runs through your mind and you remember to shower; you only started doing that when Mod 1 started. It’s time to get this day going; take care of your pets first.", picture: "images/pet.jpg")
commute = Scenario.create(title: "Travel Time", content: "Alright, morning hygiene and errands taken care of. You’ve got to commute to school. How are you going to get there?", picture: "images/travel.jpg")
arrival = Scenario.create(title: "Arriving at School", content: "You sit down, and something tickles at your senses. The smell of delicious food. Where is it coming from?", picture: "images/arrival.jpg")
labs = Scenario.create(title: "Lab Time", content: "That was delicious, but now you’ve got to get your head in the code zone. Let’s start by going over some labs. How are you doing on those?", picture: "images/labs.jpg")
challenge = Scenario.create(title: "Code Challenge Time", content: "Oh no. It’s the day of the code challenge! I mean, sure, you forgot your own name and gender, but how could you forget this? Ok. Take a breath, relax. You can do this. The challenge gets deployed, you open it up on GitHub. How do you proceed?", picture: "images/labs.jpg")
lunch = Scenario.create(title: "Lunch Time", content: "It’s now noon. For better or worse, the code-challenge is over. You need lunch. Where do you want to go?", picture: "images/lunch.jpg")
project = Scenario.create(title: "Project Time", content: "Now that you’re back from lunch, you’ve got to start coming up with ideas for your mod project. What’s on your mind?", picture: "images/project.jpg")
feelings = Scenario.create(title: "Feelings Time", content: "It’s time for Feelings. You are a part of the smartest group of people you’ve ever met, yet you collectively lose the ability to count out the appropriate number of chairs. You reshuffle the room a few times until you are left with the loosest definition of a circle. The instructor begins the session, what do you do?", picture: "images/feelings.jpg")
leave = Scenario.create(title: "Leaving Time", content: "It’s been a long and productive work day. What time were you thinking of leaving?", picture: "images/leaving.jpg")
